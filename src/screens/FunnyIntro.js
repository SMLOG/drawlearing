...
const Container = styled.div`
    padding: 40px;
    border-radius: 15px;
    background: linear-gradient(135deg, #e0f7fa, #ffe0b2); /* Softer gradient background */
    box-shadow: 0 4px 20px rgba(0, 0, 0, 0.2); /* Lighter shadow for a calm effect */
...
const Title = styled.h1`
    font-size: 68px;
    margin: 20px 0;
    color: #ff6f61; /* Softer color for the title */
...
const Blockquote = styled.blockquote`
    ...
    background-color: #fff3e0; /* Light peach background for emphasis */
